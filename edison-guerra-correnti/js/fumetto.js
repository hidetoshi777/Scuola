(function () {
  const captions = [
    "Tavola 1 — Menlo Park: Edison cerca un filamento che faccia durare la luce.",
    "Tavola 2 — Manhattan: illuminare la città con corrente continua (CC) e Morgan.",
    "Tavola 3 — Westinghouse propone di collaborare; Edison rifiuta — nasce la guerra delle correnti.",
    "Tavola 4 — Tesla e Westinghouse con la CA; Chicago 1893 sceglie il loro sistema.",
    "Tavola 5 — Kinetoscopio e ripasso: CC vicino, CA lontano; oggi in casa usiamo CA 230 V.",
  ];
