(function () {
  const captions = [
    "Tavola 1 — Due frecce sulla lavagna: metodo deduttivo e metodo induttivo. Da dove parti?",
    "Tavola 2 — Deduttivo: dal generale al particolare. Se le premesse sono vere, lo è anche la conclusione.",
    "Tavola 3 — Induttivo: dai casi particolari sali a una regola. Utile, ma resta probabilità.",
    "Tavola 4 — Premesse e conclusione: senza basi chiare il ragionamento vacilla.",
    "Tavola 5 — In medicina e nelle scienze: dati, prove, generalizzazioni… e controlli.",
    "Tavola 6 — Ricorda: direzione (generale↔particolare) e forza (certezza vs probabilità).",
  ];
