(function () {
  const captions = [
    "Tavola 1 — In punto: What time is it? / It’s eight o’clock.",
    "Tavola 2 — E mezza: It’s half past ten.",
    "Tavola 3 — Un quarto: quarter past three / quarter to five.",
    "Tavola 4 — Ricorda così: o’clock, half past, quarter past, quarter to.",
  ];
