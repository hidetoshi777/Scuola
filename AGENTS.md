...
- **Riuso immagini (obbligatorio)**: le scene e i ritratti fatti per il fumetto / la Storia vanno **riproposti** anche in Home, Imparare e Laboratorio (schede, hero, thumb), così il materiale resta coerente e non si spreca lavoro grafico.
...
- **Imparare = studio ricco**: `imparare.html` è la sezione di **studio**, non un riassunto estetico né tre bullet superficiali. Deve contenere le **informazioni da sapere** con **spiegazioni e esempi** (soprattutto in filosofia: definizioni, contrasti, casi). Date, cause, fatti, distinzioni chiave. Poi rendile **facili da ricordare**: «ricorda così», timeline, contrasti (X ≠ Y). **Niente acronimi forzati**. Niente solo immagini con una riga di testo.
