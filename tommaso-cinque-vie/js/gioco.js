(function () {
  ...
  function finish() {
    ...
    endText.textContent =
      score === totale
        ? `Punteggio ${score}/${totale}. Il cammino delle cinque vie è completo: fede, ragione e legge naturale sono a posto.`
        : `Punteggio ${score}/${totale}. Rileggi Imparare o il fumetto sulle tappe incerte, poi rifai il cammino.`;
