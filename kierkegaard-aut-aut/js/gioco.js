(function () {
  ...
  function showStop() {
    ...
    meta.textContent = stop.tipo === "scelta" ? "Aut-aut · scelta" : "Domanda di ripasso";
  ...
  function finish() {
    ...
    endText.textContent =
      score === totale
        ? `Punteggio ${score}/${totale}. Hai attraversato il bivio: estetico, etico, angoscia e salto sono a posto.`
