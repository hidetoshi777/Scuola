(function () {
  ...
  function finish() {
    ...
    endText.textContent =
      score === totale
        ? `Punteggio ${score}/${totale}. Hai tenuto distinte direzione e certezza: deduttivo ≠ induttivo.`
        : `Punteggio ${score}/${totale}. Rileggi Imparare o il fumetto sulle tappe incerte, poi rifai il percorso.`;
