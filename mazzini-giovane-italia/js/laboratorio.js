(function () {
  ...
  function check() {
    ...
    if (placed < total) {
      ...
      feedback.textContent = `Ne mancano ${total - placed}. Metti tutte le schede nei tre protagonisti.`;
      return;
    }
    ...
    if (giusti === total) {
      feedback.textContent = "Perfetto: Mazzini, Cavour e Garibaldi sono a posto. Ora affronta Metternich e Radetzky.";
