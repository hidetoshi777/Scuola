(function () {
  const captions = [
    "Tavola 1 — Clara incontra Kant sotto il cielo di Königsberg: due meraviglie, fuori e dentro.",
    "Tavola 2 — Rivoluzione copernicana: la mente filtra. Fenomeno sì, noumeno no (come oggetto).",
    "Tavola 3 — I giudizi sintetici a priori: il cuore della Critica della ragion pura.",
    "Tavola 4 — Imperativo categorico: universalizza la massima; l’uomo è fine, non solo mezzo.",
  ];
