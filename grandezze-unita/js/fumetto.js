(function () {
  const captions = [
    "Tavola 1 — «Così» non basta: serve un numero e un’unità. Il tubo è 80 cm.",
    "Tavola 2 — Tre basi: metro (m), chilogrammo (kg), secondo (s).",
    "Tavola 3 — SI: lo stesso metro per tutti. Numero e unità sempre insieme.",
    "Tavola 4 — Derivate: area in m², volume in m³. Si calcolano.",
    "Tavola 5 — Velocità: v = s / t. 90 m in 9 s = 10 m/s = 36 km/h.",
    "Tavola 6 — Ricorda: mai solo il numero. Basi e derivate.",
  ];
