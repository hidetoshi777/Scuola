(function () {
  const captions = [
    "Tavola 1 — Dal latino al volgare: nascono le prime esperienze letterarie in italiano.",
    "Tavola 2 — Scuola siciliana: corte di Federico II e invenzione del sonetto.",
    "Tavola 3 — Dolce stil novo: amore gentile e donna-angelo.",
    "Tavola 4 — Dante e Beatrice: «Tanto gentile e tanto onesta pare».",
    "Tavola 5 — Cecco Angiolieri: parodia e realismo contro lo stilnovo.",
    "Tavola 6 — Ricorda le tre scuole: siciliana, stilnovo, comico-realista.",
  ];
