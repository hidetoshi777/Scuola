(function () {
  ...
  const stops = data && data.percorso;
  ...
  function showStop() {
    ...
    meta.textContent = stop.tipo === "scelta" ? "Bivio · scelta" : "Domanda di ripasso";
  ...
  function finish() {
    ...
    endText.textContent =
      score === totale
        ? `Punteggio ${score}/${totale}. Hai tenuto distinte le tre scuole: siciliana, stilnovo, comico-realista.`
        : `Punteggio ${score}/${totale}. Rileggi lo Studio o il fumetto sulle tappe incerte, poi rifai il percorso.`;
