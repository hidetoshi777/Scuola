(function () {
  ...
  function buildSvgMarkup(data) {
    ...
    return `
<svg xmlns="http://www.w3.org/2000/svg" class="volt-svg" viewBox="0 0 420 260" role="img" aria-label="${aria}">
  <defs>
  ...
  <text x="${cableX + cableLen / 2}" y="${cableY + thick + 18}" text-anchor="middle" font-size="10" font-weight="700" fill="#f0b429">ΔU ≈ ${fmtNum(delta, 1)} V persi</text>
