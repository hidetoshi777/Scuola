(function () {
  const KEY = "tema-mazzini-giovane-italia";
  ...
  document.querySelectorAll(".manifesto-nav a[href]").forEach((link) => {
  ...
  window.AudioUi = {
    ...
    beep(kind) {
      ...
      try {
        ...
        osc.type = "sine";
        osc.frequency.value =
          kind === "ok" ? 540 : kind === "win" ? 720 : kind === "page" ? 280 : kind === "hit" ? 160 : 180;
