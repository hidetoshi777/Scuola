(function () {
  const captions = [
    "Tavola 1 — Nora incontra Kierkegaard nella nebbia di Copenaghen: contano le scelte.",
    "Tavola 2 — Stadio estetico: piacere e novità… poi arriva la noia.",
    "Tavola 3 — Stadio etico: scegliere un impegno e risponderne.",
    "Tavola 4 — Angoscia: vertigine davanti alla libertà, non solo paura di un pericolo.",
    "Tavola 5 — Stadio religioso e salto della fede: oltre la sola ragione dimostrativa.",
    "Tavola 6 — Dopo Kierkegaard: Sartre e Camus; ricorda gli stadi e i nodi chiave.",
  ];
