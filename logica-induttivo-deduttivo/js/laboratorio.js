(function () {
  ...
  function check() {
    ...
    if (placed < total) {
      ...
      feedback.textContent = `Ne mancano ${total - placed}. Metti tutte le schede nei due metodi.`;
      return;
    }
    ...
    if (giusti === total) {
      feedback.textContent = "Perfetto: deduttivo e induttivo sono a posto. Ora prova il percorso.";
